...
/* public static final String DATETIME_COLUMN = "datetime";
 ...
 public DBItem insert(DBItem item) {
     ...
     cv.put(COUNTRY_NAME, item.getCountryName());
     cv.put(COUNTRY_LATITUDE, item.getLatitude());
     cv.put(COUNTRY_LONGITUDE, item.getLongitude());
 ...
 public DBItem getRecord(Cursor cursor) {
     ...
     result.setCountryName(cursor.getString(1));
 ...
 public void sample() {
    /* Item item = new Item(0, new Date().getTime(), Colors.RED, "關於Android Tutorial的事情.", "Hello content", "", 0, 0, 0);
	 ...
	 DBItem item = new DBItem("法國","46.71","1.71");
	 DBItem item2 = new DBItem("台灣","23.55","121.02");
	 DBItem item3 = new DBItem("泰國","13.03","101.49");
	 DBItem item4 = new DBItem("南韓","35.86","127.09");
